...
class CustomColors {
  ...
  final Color sahiContainerBg;
  final Color sahiContainerBorder;
  final Color sahiTabBg;
  final Color sahiTabBorder;
  final Color sahiTabActiveBg;
  final Color sahiTabActiveText;
  final Color sahiTabInactiveText;
  final Color sahiPromptBg;
  final Color sahiTextPrimary;
  final Color sahiTextSecondary;
  final Color sahiChipEnabledBg;
  final Color sahiChipEnabledBorder;
  final Color sahiChipEnabledText;
  final Color sahiChipDisabledBg;
  final Color sahiChipDisabledBorder;
  final Color sahiChipDisabledText;
  final Color sahiPanelHeaderBg;
  ...
  CustomColors(
      ...
      required this.sahiContainerBg,
      required this.sahiContainerBorder,
      required this.sahiTabBg,
      required this.sahiTabBorder,
      required this.sahiTabActiveBg,
      required this.sahiTabActiveText,
      required this.sahiTabInactiveText,
      required this.sahiPromptBg,
      required this.sahiTextPrimary,
      required this.sahiTextSecondary,
      required this.sahiChipEnabledBg,
      required this.sahiChipEnabledBorder,
      required this.sahiChipEnabledText,
      required this.sahiChipDisabledBg,
      required this.sahiChipDisabledBorder,
      required this.sahiChipDisabledText,
      required this.sahiPanelHeaderBg,
  ...
  CustomColors get customColors {
    if (brightness == Brightness.light) {
      return CustomColors(
          ...
          sahiContainerBg: const Color(0xFFFDF8FF),
          sahiContainerBorder: const Color(0x80C9C4D3),
          ...
          sahiTabActiveText: Colors.white,
          sahiTabInactiveText: const Color(0xFF4A4A4A),
          sahiPromptBg: const Color(0xFFF7F2FA),
          sahiTextPrimary: const Color(0xFF2D2D2D),
          sahiTextSecondary: const Color(0xFF6B6B6B),
          sahiChipEnabledBg: const Color(0xFFFDF8FF),
          sahiChipEnabledBorder: const Color(0x80C9C4D3),
          sahiChipEnabledText: const Color.fromRGBO(78, 64, 150, 1),
          sahiChipDisabledBg: const Color(0x0A000000),
          sahiChipDisabledBorder: const Color(0x33000000),
          sahiChipDisabledText: const Color(0xFFAAAAAA),
          sahiPanelHeaderBg: const Color(0xFFF7F2FA),
          sahiDivider: const Color(0xFFC9C4D3),
          sahiPanelItemBg: const Color.fromRGBO(253, 248, 255, 1),
          sahiPrimaryTextColor: const Color.fromRGBO(90, 79, 160, 1));
    } else {
      return CustomColors(
        ...
        strikePriceHeaderColor: const Color.fromRGBO(70, 38, 72, 1),
        ...
        sahiContainerBg: const Color(0xFF2A2533),
        sahiContainerBorder: const Color(0xFF4A4455),
        sahiTabBg: const Color(0xFF4A4455),
        sahiTabBorder: const Color(0x804A4455),
        sahiTabActiveBg: const Color(0xFF9B8EC4),
        sahiTabActiveText: Colors.white,
        sahiTabInactiveText: const Color(0xFFCCCCCC),
        sahiPromptBg: const Color(0xFF2A2533),
        sahiTextPrimary: const Color(0xFFEEEEEE),
        sahiTextSecondary: const Color(0xFF999999),
        sahiChipEnabledBg: const Color(0x1A9B8EC4),
        sahiChipEnabledBorder: const Color(0x4D9B8EC4),
        sahiChipEnabledText: const Color(0xFF9B8EC4),
        sahiChipDisabledBg: const Color(0x0AFFFFFF),
        sahiChipDisabledBorder: const Color(0x33FFFFFF),
        sahiChipDisabledText: const Color(0xFF666666),
        sahiPanelHeaderBg: const Color(0xFF2A2533),
        sahiDivider: const Color(0xFF4A4455),
        sahiPanelItemBg: const Color.fromRGBO(253, 248, 255, 1),
        sahiPrimaryTextColor: const Color.fromRGBO(90, 79, 160, 1),
      );
    }
